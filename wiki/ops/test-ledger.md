...
| 2026-05-22 | outer-loop-python-profile | `python -m py_compile gomoku/self_play.py gomoku/selfplay_worker.py` | passed | Worker receipt `20260522T061713Z/01-outer-loop-python-profile` |
| 2026-05-22 | outer-loop-python-profile | `python -m gomoku.selfplay_worker --weights-path sweep_logs/outer-loop-profile-20260522T061713Z/checkpoints/worker_weights.pt --output-dir sweep_logs/outer-loop-profile-20260522T061713Z/records-wave --worker-id profile --device mps --games-per-batch 8 --n-simulations 400 --wave-size 64 --max-plies 16 --wave-mode --seed 0 --max-batches 1 --profile-output sweep_logs/outer-loop-profile-20260522T061713Z/profile-mps-wave-mode-8g-s400-p16.json` | passed; wall 1.064s; evaluator 84.3%; native_search_batch 95.2%; post-search Python 4.7%; no 10-20% post-search owner found | Open note `wiki/ops/open-notes/20260522T061713Z-01-outer-loop-python-profile.md`; raw JSON path named in receipt was not present in main after integration |
| 2026-05-22 | outer-loop-python-profile | non-wave cross-check worker profile, same checkpoint/8g/400sims/wave64/max_plies16/seed0 without `--wave-mode` | passed; wall 1.235s; evaluator 86.9%; native search excluding evaluator 8.7%; post-search Python 4.4% | Open note `wiki/ops/open-notes/20260522T061713Z-01-outer-loop-python-profile.md` |
| 2026-05-22 | outer-loop-python-profile | `python scripts/perf_microbench.py --device cpu --size tiny --games 2 --n-simulations 2 --wave-size 1 --max-plies 2 --repeats 1 --warmup 0` | passed | Worker receipt `20260522T061713Z/01-outer-loop-python-profile` |
| 2026-05-22 | outer-loop-python-profile | `pytest -q` | passed | Worker receipt `20260522T061713Z/01-outer-loop-python-profile` |
