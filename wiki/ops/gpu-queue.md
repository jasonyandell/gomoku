---
**📦 QUEUE STATE FROZEN 2026-05-24** — The 9×9 perf-optimization era is closed. This queue documents the two-queue scheduler DOCTRINE (which remains LIVE, cited by `gomoku-research-lab` skill) and the research lanes that executed against it. **The listed lanes/queue DATA is a historical snapshot from the M5-Max era** (perf-cells on Metal MPS). Active work has moved to 15×15 board size + VCT-science focus. See `ops.md` § scope-boundary for current operational framing.
...
depends_on: [L10, L11 *(both completed-lane entries; removed 2026-07-04; recover: `git show ca76350:wiki/_archive/gpu-queue-completed-2026-05.md`)*]
prep_cells: none
measurement_cells:
...
code_change: false
depends_on: [L10 *(completed-lane entry; see recovery note above)*]
prep_cells:
...
**Rotated 2026-07-04:** the 45-row completed-lane research ledger (2026-05-23/24 —
delta-e runs, LF1-followups, fp16 lanes, ANE residency, heat-soak, and the rest)
was cut from this file; it is preserved in git history, not a parallel
directory *(recover: `git show ca76350:wiki/_archive/gpu-queue-completed-2026-05.md`)*.
Lane IDs referenced above (L01–L14, delta-e-*, Lpwr*, Lhot) resolve there.
