...
> - **🎯 THE NEW CEILING — lookahead:depth=6 (40g confirmed).** **Baseline: 14W/6L/0D black + 0W/4L/16D white = 70% Bwin, 20% Wloss, dist 0.5** at default config (sims=100, no levers). Unlike la4 (always wins or draws, never loses), la6 beats the champion in REAL games — 6 black losses + 4 white losses across 40 games. This is the genuine ceiling worth attacking. **Next research objective shifts from "close la4-Bwin" (already closed) to "break the la6 ceiling."** The eval-side levers (FPU/tree-reuse/proven-prop/eval-VCF) become directly relevant — they were built for "tactical depth at eval" which is exactly what's needed vs la6. **4-axis cheap-first matrix probe IN PROGRESS** (vcf × fpu × reuse × proven_prop on champion vs la6, 40g/cell, 16 cells, ~3-4h, backgrounded 16:05Z). Results will tell us whether the eval-side investment actually moves la6.
