# Idea-pile — graduated result narratives (full-fidelity archive)

> **Archived 2026-07-04.** These are the verbatim dated result-narratives that
> grew inside [idea-pile.md](../../topics/idea-pile.md) for ideas **#9 (batch-VCF /
> GPU-VCF)**, **#10 (threat-molecule representation)**, and **#11 (VCT-terminus
> self-play)**. They were lifted out so the pile stays a lean *seed* list; the
> canonical living homes are [gpu-vct-feasibility.md](../../topics/gpu-vct-feasibility.md),
> [molecule-discovery-toolkit.md](../../topics/molecule-discovery-toolkit.md),
> [the-claw.md](../../topics/the-claw.md),
> [vct-terminus-selfplay-result.md](../../topics/vct-terminus-selfplay-result.md), and
> [vct-defense-aux-head-result.md](../../topics/vct-defense-aux-head-result.md). No facts
> were deleted — this file preserves them verbatim.

---

## #9 — Batch-VCF "certain-death" guard-rail (full narrative)
...
## #10 — Threat-molecule representation (full narrative)
...
## #11 — VCT-terminus self-play (full narrative)
