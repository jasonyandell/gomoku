<!-- ARCHIVED 2026-07-04 (full fidelity). This is the complete verbatim v1 design.
The live page wiki/topics/sliding-derby-design.md was reduced to the banner + §0
verification table + the reuse-ledger appendix + a pointer here; §§1–7 (architecture,
frozen-reference gate, GPU-contention model, priority engine, state/resumability,
adversarial wedge-check, MVP checklist) live here in full. Superseded as a design by
sliding-derby-measured-outcomes-design-v2.md; the autonomous Derby is stopped. -->
