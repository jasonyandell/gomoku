# White-side defense plan — FULL chronicle (archived)

**Status: HISTORICAL / ARCHIVE — full-fidelity verbatim, 2026-07-04.** This is the complete white-side-defense investigation chronicle (2026-06-15 → 2026-06-20), moved verbatim out of [white-side-defense-plan.md](../../topics/white-side-defense-plan.md) during the 2026-07-04 wiki curation. The parent page now carries the compressed HISTORICAL synthesis; this archive preserves every dated UPDATE banner, table, and file:line audit for anyone reconstructing the reasoning trail. The investigation is superseded-by swap2 (#72); the canonical statement of the first-player-win theorem it discovered lives in [alphazero-lessons-15x15-gomoku.md](../../topics/alphazero-lessons-15x15-gomoku.md) §15. No facts were changed — only relocated.
