# Research Board — v1 to v6 Closed Verdicts (Historical)

**ARCHIVED: 2026-07-04.** The 9×9 classic `delo_derby` (v1–v9) ran 2026-05-24→27 and concluded. v1–v6 verdicts live here; for the current champion (v9 CONCLUDED) and open candidates, see [ops/research-board.md](../ops/research-board.md).
